...
export const questions: Question[] = [
  {
    id: 'pb16-1',
    text: "A patient with a history of dementia presents to the emergency department with auditory hallucinations. The patient reports hearing voices that are calling their name. What is the most appropriate initial response by the nurse?",
    options: [
  ...
  {
    id: 'pb16-3',
    text: "A patient with a history of traumatic brain injury presents to the emergency department with auditory hallucinations. The patient reports hearing voices that are critical and abusive. What is the most appropriate initial response by the nurse?",
    options: [
      "Administer an antipsychotic medication as prescribed",
      "Encourage the patient to ignore the voices",
      "Ask the patient to describe the voices in more detail",
  ...
  {
    id: 'pb16-4',
    text: "What is the correct position for an adult patient during an ear examination?",
    options: [
  ...
  {
    id: 'pb16-5',
    text: "You receive an email from a client expressing frustration with a care received. How should you respond?",
    options: [
  ...
  {
    id: 'pb16-6',
    text: "A 1-month-old infant is brought to the clinic for a well-baby visit. What is the expected physical milestone for this infant?",
    options: [
  ...
  {
    id: 'pb16-7',
    text: "A 4-month-old infant is brought to the clinic for a well-baby visit. What is the expected cognitive milestone for this infant?",
    options: [
      "Imitating sounds",
  ...
  {
    id: 'pb16-8',
    text: "A 6-month-old infant is brought to the clinic for a well-baby visit. What is the expected language milestone for this infant?",
    options: [
  ...
  {
    id: 'pb16-9',
    text: "A 9-month-old infant is brought to the clinic for a well-baby visit. What is the expected gross motor milestone for this infant?",
    options: [
  ...
  {
    id: 'pb16-10',
    text: "A 12-month-old infant is brought to the clinic for a well-baby visit. What is the expected fine motor milestone for this infant?",
    options: [
  ...
  {
    id: 'pb16-11',
    text: "A 2-month-old infant is brought to the clinic for a well-baby visit. What is the expected physical milestone for this infant?",
    options: [
  ...
  {
    id: 'pb16-12',
    text: "A 5-month-old infant is brought to the clinic for a well-baby visit. What is the expected cognitive milestone for this infant?",
    options: [
  ...
  {
    id: 'pb16-13',
    text: "A 7-month-old infant is brought to the clinic for a well-baby visit. What is the expected language milestone for this infant?",
    options: [
      "Babbling with consonant-vowel combinations",
      "Saying “mama” or “dada”",
      "Responding to simple verbal commands",
  ...
  {
    id: 'pb16-14',
    text: "A 10-month-old infant is brought to the clinic for a well-baby visit. What is the expected gross motor milestone for this infant?",
    options: [
      "Sitting up without support",
      "Crawling",
  ...
  {
    id: 'pb16-15',
    text: "A 12-month-old infant is brought to the clinic for a well-baby visit. What is the expected social-emotional milestone for this infant?",
    options: [
  ...
  {
    id: 'pb16-16',
    text: "A patient offers you a cup of coffee as a gesture of appreciation for the care you have provided. What do you do?",
    options: [
  ...
  {
    id: 'pb16-17',
    text: "A 30-year-old patient presents to the emergency department with a full-thickness burn covering 20% of their body surface area. Which of the following electrolytes is most likely to be lost in large quantities due to the burn injury?",
    options: [
      "Potassium (K⁺)",
      "Sodium (Na⁺)",
      "Magnesium (Mg²⁺)",
  ...
  {
    id: 'pb16-18',
    text: "A terminally ill patient, who is expected to pass away soon, requests that you stay with him during his final moments. However, you have other patients to attend to and your shift is about to end. What do you do?",
    options: [
  ...
  {
    id: 'pb16-19',
    text: "A 2-year-old toddler is throwing a tantrum in the clinic waiting area, becoming increasingly agitated and disrupting other patients. The child’s father tries to calm them down, but it’s not working. What is the most effective method to manage the situation?",
    options: [
  ...
  {
    id: 'pb16-20',
    text: "A 20-year-old university student presents to the emergency department with symptoms of meningitis, including fever, headache, and stiff neck. What is the primary mode of transmission for Neisseria meningitidis, the bacterium that causes meningococcal meningitis?",
    options: [
  ...
  {
    id: 'pb16-21',
    text: "A nurse is preparing to change the dressing on a patient's wound. What is the primary purpose of handwashing before performing wound care?",
    options: [
  ...
  {
    id: 'pb16-22',
    text: "A 6-year-old child is newly diagnosed with type 1 diabetes and requires insulin injections. The parents are worried about the pain associated with insulin injections and ask the nurse for advice. What is the best response?",
    options: [
  ...
  {
    id: 'pb16-23',
    text: "A patient presents to the pharmacy with a concern that the color of their tablet has changed since their last refill. They are worried that the medication may be a new or a different one or that the doctor has changed their prescription without telling them. What is the most appropriate response by the pharmacist?",
    options: [
  ...
  {
    id: 'pb16-24',
    text: "A 75-year-old patient with a history of hypertension and coronary artery disease is admitted to the hospital with symptoms of congestive heart failure (CHF). Which of the following medications would be most appropriate to administer to this patient?",
    options: [
      "Furosemide (Lasix)",
  ...
  {
    id: 'pb16-26',
    text: "A patient with CHF is taking a beta-blocker and an ACE inhibitor. The patient's blood pressure is 100/60 mmHg, and the patient is experiencing symptoms of fatigue and dizziness. Which of the following medications would be most appropriate to add to the patient's regimen?",
    options: [
      "Furosemide (Lasix)",
      "Metoprolol (Lopressor)",
      "Lisinopril (Zestril)",
  ...
  {
    id: 'pb16-27',
    text: "A patient with CHF is experiencing symptoms of anxiety and depression. Which of the following interventions would be most beneficial for this patient?",
    options: [
  ...
  {
    id: 'pb16-28',
    text: "A 45-year-old male patient is admitted to the emergency department with severe injuries from a motor vehicle accident. His vital signs are: BP: 80/40 mmHg, HR: 120 bpm, RR: 32 breaths/min, O2 Sat: 88% on room air. The patient is diagnosed with hypovolemic shock. Which of the following interventions would be the most appropriate initial management?",
    options: [
  ...
  {
    id: 'pb16-29',
    text: "A 30-year-old female patient is admitted to the emergency department with severe burns covering 40% of her body. Her vital signs are: BP: 90/60 mmHg, HR: 110 bpm, RR: 28 breaths/min, O2 Sat: 92% on room air. The patient is diagnosed with hypovolemic shock. Which of the following fluid resuscitation strategies would be most appropriate for this patient?",
    options: [
  ...
  {
    id: 'pb16-30',
    text: "A 50-year-old male patient is admitted to the intensive care unit with severe sepsis. His vital signs are: BP: 80/40 mmHg, HR: 120 bpm, RR: 28 breaths/min. The patient is diagnosed with septic shock. Which of the following interventions would be most appropriate to improve the patient’s blood pressure?",
    options: [
  ...
  {
    id: 'pb16-31',
    text: "A 20-year-old male patient is admitted to the emergency department with severe injuries from a motor vehicle accident. His vital signs are: BP: 60/40 mmHg, HR: 140 bpm, RR: 36 breaths/min, O2 Sat: 80% on room air. The patient is diagnosed with cardiogenic shock. Which of the following interventions would be most appropriate to improve the patient’s cardiac output?",
    options: [
  ...
  {
    id: 'pb16-32',
    text: "A 60-year-old male patient presents to the emergency department with sudden onset of weakness and numbness in his left arm and left leg. The symptoms resolve within 30 minutes. What is the most likely diagnosis?",
    options: [
      "Ischemic stroke",
  ...
  {
    id: 'pb16-33',
    text: "A patient with a history of hypertension and hyperlipidemia presents with symptoms of TIA. Which of the following is the most important immediate action to take?",
    options: [
      "Administer aspirin",
  ...
  {
    id: 'pb16-34',
    text: "A patient with a history of TIA is being evaluated for risk factor modification. Which of the following is the most important modifiable risk factor for stroke?",
    options: [
      "Hypertension",
      "Hyperlipidemia",
      "Diabetes mellitus",
  ...
  {
    id: 'pb16-35',
    text: "A patient with a history of TIA is being evaluated for anticoagulation therapy. Which of the following is the most appropriate anticoagulant for this patient?",
    options: [
      "Warfarin",
      "Aspirin",
      "Clopidogrel",
  ...
  {
    id: 'pb16-36',
    text: "A patient is receiving IV antibiotics through a peripheral IV line. The nurse notices that the patient’s hand is swollen and cool to the touch, and the patient reports pain and numbness in the affected area. Which of the following is the most likely cause of these symptoms?",
    options: [
      "Phlebitis",
      "Infiltration",
      "Extravasation",
  ...
  {
    id: 'pb16-37',
    text: "A patient is experiencing IV infiltration. Which of the following actions should the nurse take first?",
    options: [
      "Remove the IV line",
  ...
  {
    id: 'pb16-38',
    text: "A patient is at risk for IV infiltration. Which of the following nursing interventions can help prevent IV infiltration?",
    options: [
  ...
  {
    id: 'pb16-39',
    text: "A patient is receiving a blood transfusion and suddenly develops a fever of 39°C. Which of the following actions should the nurse take first?",
    options: [
  ...
  {
    id: 'pb16-40',
    text: "A patient is receiving a blood transfusion and develops a fever of 39°C. Which of the following is the most likely cause of the fever?",
    options: [
  ...
  {
    id: 'pb16-42',
    text: "A patient with schizophrenia is experiencing a sudden increase in psychotic symptoms, including hallucinations and delusions. The patient's nurse observes that the patient is becoming increasingly agitated and restless. What is the most likely cause of the patient's sudden increase in psychotic symptoms?",
    options: [
  ...
  {
    id: 'pb16-43',
    text: "A patient with a history of schizophrenia is being discharged from the hospital. The patient's nurse is providing education on medication management and side effects. What is the primary goal of medication management for patients with schizophrenia?",
    options: [
  ...
  {
    id: 'pb16-44',
    text: "What is the primary purpose of handwashing in healthcare settings?",
    options: [
  ...
  {
    id: 'pb16-45',
    text: "A nurse notices that a medication order seems unusually high. What should the nurse do first?",
    options: [
  ...
  {
    id: 'pb16-46',
    text: "A patient refuses to take their prescribed medication. What is the nurse's best course of action?",
    options: [
  ...
  {
    id: 'pb16-47',
    text: "A nurse needs to decide on the best way to manage a patient's pain. What should the nurse consider first?",
    options: [
  ...
  {
    id: 'pb16-48',
    text: "When should a nurse prioritize a non-urgent task over an urgent one?",
    options: [
  ...
  {
    id: 'pb16-49',
    text: "A nurse is assigned to a patient who needs immediate care but is also responsible for other patients. What should the nurse do first?",
    options: [
  ...
  {
    id: 'pb16-50',
    text: "A patient is prescribed warfarin 5mg orally daily. What should the nurse monitor closely?",
    options: [
      "Blood pressure",
      "Blood glucose",
  ...
  {
    id: 'pb16-51',
    text: "A patient presents with a sudden onset of chest pain radiating to the arm. What is the nurse's priority action?",
    options: [
      "Administer oxygen",
      "Call the doctor",
  ...
  {
    id: 'pb16-52',
    text: "A nurse is caring for a patient with a confirmed case of COVID-19. What personal protective equipment (PPE) should the nurse wear?",
    options: [
  ...
  {
    id: 'pb16-53',
    text: "A patient refuses treatment for a life-threatening condition. What should the nurse do?",
    options: [
...
add this new questions into Test 16 now Test 16 has 65 questions please upload it now I'll send the remaining questions later